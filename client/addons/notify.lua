...
Citizen.InvokeNative("0xCB5D11F9508A928D", 1, a2:Buffer(), a3:Buffer(), GetHashKey("UPGRADE_HEALTH_TANK_1"), 1084182731, Internal_Config.Player.MaxHealthCore, 752097756)
local a2 = DataView.ArrayBuffer(12 * 8)
local a3 = DataView.ArrayBuffer(12 * 8)
Citizen.InvokeNative("0xCB5D11F9508A928D", 1, a2:Buffer(), a3:Buffer(), GetHashKey("UPGRADE_STAMINA_TANK_1"), 1084182731, Internal_Config.Player.MaxStaminaCore, 752097756)