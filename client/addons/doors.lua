--
-- This is an addon script that will unlock all doors that should be unlocked 
-- (as well as lock some that should be) so that banks and other buildings can be entered.
--

-- Credit to kibook @ https://github.com/kibook/redm-doors
