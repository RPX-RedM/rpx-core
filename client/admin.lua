...
RegisterNetEvent("RPXAdmin:client:Spectate", function(position, player)
    if not Spectating then
        ...
        TriggerEvent("RPXAdmin:client:StopSpectating")
    end
end)

RegisterNetEvent("RPXAdmin:client:StopSpectating", function()
    Spectating = false
...
RegisterNetEvent("RPXAdmin:client:SetScale", function(scale)
...
RegisterNetEvent("RPX:client:SetModel", function(model)
...
RegisterNetEvent("RPXAdmin:client:SetInvis", function()
...
RegisterNetEvent("RPXAdmin:client:TeleportToMarker", function()
...
--------------------------------------------------------------------------------------
RegisterNetEvent("RPXAdmin:client:DeleteVehicle", function()
...
RegisterNetEvent("RPXAdmin:client:DeleteVehicleAdmin", function()
    if IsPedSittingInAnyVehicle(PlayerPedId()) then 
        local currentvehicle = GetVehiclePedIsIn(PlayerPedId(),false)
        SetEntityAsMissionEntity(currentvehicle,true,true)
        DeleteVehicle(currentvehicle)
